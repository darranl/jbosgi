 ...
 */
package org.jboss.test.osgi.example.jbossas.http;
...
/**
 * A test that deployes a bundle that uses {@link HttpService}
 *
...
public class HttpServiceTestCase {
    ...
    private String performCall(String path) throws Exception {
        return HttpSupport.getHttpResponse("localhost", 8080, "/httpservice" + path);
    }
